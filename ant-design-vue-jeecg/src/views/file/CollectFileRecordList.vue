<template>
  <a-card :bordered="false">
    ...
    <!-- <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('文件收藏记录')">导出</a-button>
    ...
    <collect-file-record-modal ref="modalForm" @ok="modalFormOk"></collect-file-record-modal>
  </a-card>
</template>
...
<script>
  ...
  // import CollectFileRecordModal from './modules/CollectFileRecordModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'
import JInput from '@/components/jeecg/JInput'
  export default {
    name: 'CollectFileRecordList',
    ...
    data () {
      return {
        ...
        url: {
          list: "/collectFileRecord/list",
          delete: "/collectFileRecord/delete",
          deleteBatch: "/collectFileRecord/deleteBatch",
          exportXlsUrl: "/collectFileRecord/exportXls",
          importExcelUrl: "collectFileRecord/importExcel",
